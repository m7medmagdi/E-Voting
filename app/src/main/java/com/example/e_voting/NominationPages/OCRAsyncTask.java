...
public class OCRAsyncTask extends AsyncTask<String, Integer, JSONObject> {
    ...
    OCRAsyncTask(Activity activity, String apiKey, boolean isOverlayRequired, String language) {
    ...
    OCRAsyncTask(Activity activity, String apiKey, String language) {
        this.mActivity = new WeakReference<>(activity);
        this.mApiKey = apiKey;
        this.mLanguage = language;
    }
    ...
    protected JSONObject doInBackground(String... params) {
        try {
            ...
            postDataParams.put("base64Image", params[0]);
