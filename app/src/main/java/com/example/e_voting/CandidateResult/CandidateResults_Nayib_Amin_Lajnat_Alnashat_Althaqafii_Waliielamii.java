...
public class CandidateResults_Nayib_Amin_Lajnat_Alnashat_Althaqafii_Waliielamii extends AppCompatActivity {
    ...
    private void getList() {
        ...
        db.getReference("المرشحون").child("نائب امين لجنة النشاط الثقافي والاعلامي").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                list=new ArrayList <>();
                winnersAdapter = new WinnersAdapter(CandidateResults_Nayib_Amin_Lajnat_Alnashat_Althaqafii_Waliielamii.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(CandidateResults_Nayib_Amin_Lajnat_Alnashat_Althaqafii_Waliielamii.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
