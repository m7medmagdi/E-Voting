...
public class CandidateResult_Nayib_Rayiys_Aitihad_Altalaba extends AppCompatActivity {
    ...
    private void getList() {
        ...
        db.getReference("المرشحون").child("نائب رئيس اتحاد الطلبة").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                list=new ArrayList <>();
                winnersAdapter = new WinnersAdapter(CandidateResult_Nayib_Rayiys_Aitihad_Altalaba.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(CandidateResult_Nayib_Rayiys_Aitihad_Altalaba.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
