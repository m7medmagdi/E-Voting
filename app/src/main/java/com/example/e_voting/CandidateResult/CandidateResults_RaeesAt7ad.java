...
public class CandidateResults_RaeesAt7ad extends AppCompatActivity{
    ...
    private void getList() {
        ...
        db.getReference("المرشحون").child("رئيس اتحاد الطلبة").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                list=new ArrayList <>();
                winnersAdapter = new WinnersAdapter(CandidateResults_RaeesAt7ad.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(CandidateResults_RaeesAt7ad.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
