...
public class CandidateResults_Amin_Lajnat_Aljawalih_Walkhidmat_Al3amih extends AppCompatActivity {
    ...
    private void getList() {
        ...
        db.getReference("المرشحون").child("امين لجنة الجواله والخدمة العامه").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                list=new ArrayList <>();
                winnersAdapter = new WinnersAdapter(CandidateResults_Amin_Lajnat_Aljawalih_Walkhidmat_Al3amih.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(CandidateResults_Amin_Lajnat_Aljawalih_Walkhidmat_Al3amih.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
