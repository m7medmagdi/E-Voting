...
public class CandidateResults_Nayib_Amin_Lajnat_Alnashat_Alriyadii extends AppCompatActivity {
    ...
    private void getList() {
        ...
        db.getReference("المرشحون").child("نائب امين لجنة النشاط الرياضي").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                list=new ArrayList <>();
                winnersAdapter = new WinnersAdapter(CandidateResults_Nayib_Amin_Lajnat_Alnashat_Alriyadii.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(CandidateResults_Nayib_Amin_Lajnat_Alnashat_Alriyadii.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
