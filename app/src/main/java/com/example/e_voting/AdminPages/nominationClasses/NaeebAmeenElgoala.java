...
public class NaeebAmeenElgoala extends AppCompatActivity implements RecyclerView_InterFace {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(NaeebAmeenElgoala.this));
    ...
    private void getList() {
        ...
        db.getReference("المرشحون").child("نائب امين لجنة الجواله والخدمة العامه").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                list=new ArrayList <>();
                showNominationForAdminAdapter = new ShowNominationForAdminAdapter(NaeebAmeenElgoala.this,list, NaeebAmeenElgoala.this);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(NaeebAmeenElgoala.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onItemClick(int position) {
        Intent intent  = new Intent(NaeebAmeenElgoala.this, DeleteNomination.class);
