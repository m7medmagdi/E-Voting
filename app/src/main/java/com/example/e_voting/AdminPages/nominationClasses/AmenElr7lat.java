...
public class AmenElr7lat extends AppCompatActivity implements RecyclerView_InterFace {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(AmenElr7lat.this));
    ...
    private void getList() {
        ...
        db.getReference("المرشحون").child("امين لجنة النشاط الاجتماعي والرحلات").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                list=new ArrayList <>();
                showNominationForAdminAdapter = new ShowNominationForAdminAdapter(AmenElr7lat.this,list, AmenElr7lat.this);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(AmenElr7lat.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onItemClick(int position) {
        Intent intent  = new Intent(AmenElr7lat.this, DeleteNomination.class);
