...
public class RaeesAt7ad extends AppCompatActivity implements RecyclerView_InterFace {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(RaeesAt7ad.this));
    ...
    private void getList() {
        ...
        db.getReference("المرشحون").child("رئيس اتحاد الطلبة").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                list=new ArrayList <>();
                showNominationForAdminAdapter = new ShowNominationForAdminAdapter(RaeesAt7ad.this,list, RaeesAt7ad.this);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(RaeesAt7ad.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onItemClick(int position) {
        Intent intent  = new Intent(RaeesAt7ad.this, DeleteNomination.class);
