...
public class NaeebAmeenElfnie  extends AppCompatActivity implements RecyclerView_InterFace {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(NaeebAmeenElfnie.this));
    ...
    private void getList() {
        ...
        db.getReference("المرشحون").child("نائب امين لجنة النشاط الفني").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                list=new ArrayList <>();
                showNominationForAdminAdapter = new ShowNominationForAdminAdapter(NaeebAmeenElfnie.this,list, NaeebAmeenElfnie.this);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(NaeebAmeenElfnie.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onItemClick(int position) {
        Intent intent  = new Intent(NaeebAmeenElfnie.this, DeleteNomination.class);
