...
public class NaeebAmeenAlriadee extends AppCompatActivity implements RecyclerView_InterFace {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(NaeebAmeenAlriadee.this));
    ...
    private void getList() {
        ...
        db.getReference("المرشحون").child("نائب امين لجنة النشاط الرياضي").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                list=new ArrayList <>();
                showNominationForAdminAdapter = new ShowNominationForAdminAdapter(NaeebAmeenAlriadee.this,list, NaeebAmeenAlriadee.this);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(NaeebAmeenAlriadee.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onItemClick(int position) {
        Intent intent  = new Intent(NaeebAmeenAlriadee.this, DeleteNomination.class);
