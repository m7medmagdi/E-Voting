...
public class NaeebRaeesAt7ad  extends AppCompatActivity implements RecyclerView_InterFace {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(NaeebRaeesAt7ad.this));
    ...
    private void getList() {
        ...
        db.getReference("المرشحون").child("نائب رئيس اتحاد الطلبة").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                list=new ArrayList <>();
                showNominationForAdminAdapter = new ShowNominationForAdminAdapter(NaeebRaeesAt7ad.this,list, NaeebRaeesAt7ad.this);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(NaeebRaeesAt7ad.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onItemClick(int position) {
        Intent intent  = new Intent(NaeebRaeesAt7ad.this, DeleteNomination.class);
