...
public class Amin_Lajnat_Alnashat_Alfnyi extends AppCompatActivity implements RecyclerView_InterFace {
    ...
    String Rayiys_Aitihad_Altalaba, Nayib_Rayiys_Aitihad_Altalaba, Amin_Lajnat_Alusar, Nayib_Amin_Lajnat_Alusar,
            ...
            ,Nayib_Amin_Lajnat_Alnashat_Alriyadii,SSN;
    TextView tv_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_name.setText("امين لجنة النشاط الفني");
    ...
    private void getList() {
        db.getReference("المرشحون").child("امين لجنة النشاط الفني").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                list=new ArrayList <>();
                votingAdapter = new VotingAdapter(Amin_Lajnat_Alnashat_Alfnyi.this,list,Amin_Lajnat_Alnashat_Alfnyi.this);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Amin_Lajnat_Alnashat_Alfnyi.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }

//    public void btnNext(View view) {
//        Intent intent = new Intent(Amin_Lajnat_Alnashat_Alfnyi.this, Nayib_Amin_Lajnat_Alnashat_Alfnyi.class);
...
//        intent.putExtra("امين لجنة النشاط الفني",votingAdapter.getRadioButtonValue);
//        startActivity(intent);
//    }

    @Override
    public void onItemClick(final int position) {
        new AlertDialog.Builder(Amin_Lajnat_Alnashat_Alfnyi.this)
                .setTitle("تاكيد")
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.AB_home:
                Intent intent2 = new Intent(Amin_Lajnat_Alnashat_Alfnyi.this, Home_Student.class);
                intent2.putExtra("SSN",SSN);
                startActivity(intent2);
                finish();
                return true;
            case android.R.id.home:
                Intent intent = new Intent(Amin_Lajnat_Alnashat_Alfnyi.this,Nayib_Amin_Lajnat_Alnashat_Alriyadii.class);
                intent.putExtra("رئيس اتحاد الطلبة",Rayiys_Aitihad_Altalaba);
                intent.putExtra("نائب رئيس اتحاد الطلبة",Nayib_Rayiys_Aitihad_Altalaba);
                intent.putExtra("امين لجنة الاسر",Amin_Lajnat_Alusar);
                intent.putExtra("نائب امين لجنة الاسر",Nayib_Amin_Lajnat_Alusar);
                ...
                intent.putExtra("امين لجنة النشاط الثقافي والاعلامي",Amin_Lajnat_Alnashat_Althaqafii_Waliielamii);
                intent.putExtra("نائب امين لجنة النشاط الثقافي والاعلامي",Nayib_Amin_Lajnat_Alnashat_Althaqafii_Waliielamii);
                intent.putExtra("امين لجنة النشاط الرياضي",SSN);
                intent.putExtra("SSN",SSN);
                startActivity(intent);
                finish();
                break;
