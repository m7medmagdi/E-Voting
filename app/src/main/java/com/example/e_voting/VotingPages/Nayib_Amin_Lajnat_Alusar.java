...
public class Nayib_Amin_Lajnat_Alusar extends AppCompatActivity implements RecyclerView_InterFace {
    ...
    String Rayiys_Aitihad_Altalaba, Nayib_Rayiys_Aitihad_Altalaba, Amin_Lajnat_Alusar,SSN;
    TextView tv_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_name.setText("نائب امين لجنة الاسر");
    ...
    private void getList() {
        db.getReference("المرشحون").child("نائب امين لجنة الاسر").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {

                list=new ArrayList <>();
                votingAdapter = new VotingAdapter(Nayib_Amin_Lajnat_Alusar.this,list, Nayib_Amin_Lajnat_Alusar.this);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Nayib_Amin_Lajnat_Alusar.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
//    public void btnNext(View view) {
//        Intent intent = new Intent(Nayib_Amin_Lajnat_Alusar.this, Amin_Lajnat_Aljawalih_Walkhidmat_Al3amih.class);
...
//        intent.putExtra("نائب امين لجنة الاسر",votingAdapter.getRadioButtonValue);
//        startActivity(intent);
//    }

    @Override
    public void onItemClick(final int position) {
        new AlertDialog.Builder(Nayib_Amin_Lajnat_Alusar.this)
                .setTitle("تاكيد")
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.AB_home:
                Intent intent2 = new Intent(Nayib_Amin_Lajnat_Alusar.this, Home_Student.class);
                intent2.putExtra("SSN",SSN);
                startActivity(intent2);
                finish();
                return true;
            case android.R.id.home:
                Intent intent = new Intent(Nayib_Amin_Lajnat_Alusar.this,Amin_Lajnat_Alusar.class);
                intent.putExtra("رئيس اتحاد الطلبة",Rayiys_Aitihad_Altalaba);
                intent.putExtra("نائب رئيس اتحاد الطلبة",Nayib_Rayiys_Aitihad_Altalaba);
                intent.putExtra("SSN",SSN);
                startActivity(intent);
