...
public class Amin_Lajnat_Alnashat_Althaqafii_Waliielamii extends AppCompatActivity implements RecyclerView_InterFace {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_name.setText("امين لجنة النشاط الثقافي والاعلامي");
    ...
    private void getList() {
        db.getReference("المرشحون").child("امين لجنة النشاط الثقافي والاعلامي").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {

                list=new ArrayList <>();
                votingAdapter = new VotingAdapter(Amin_Lajnat_Alnashat_Althaqafii_Waliielamii.this,list, Amin_Lajnat_Alnashat_Althaqafii_Waliielamii.this);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Amin_Lajnat_Alnashat_Althaqafii_Waliielamii.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }

//    public void btnNext(View view) {
//        Intent intent = new Intent(Amin_Lajnat_Alnashat_Althaqafii_Waliielamii.this, Nayib_Amin_Lajnat_Alnashat_Althaqafii_Waliielamii.class);
...
//        intent.putExtra("امين لجنة النشاط الثقافي والاعلامي",votingAdapter.getRadioButtonValue);
//        startActivity(intent);
//    }

    @Override
    public void onItemClick(final int position) {
        new AlertDialog.Builder(Amin_Lajnat_Alnashat_Althaqafii_Waliielamii.this)
                .setTitle("تاكيد")
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.AB_home:
                Intent intent2 = new Intent(Amin_Lajnat_Alnashat_Althaqafii_Waliielamii.this, Home_Student.class);
                intent2.putExtra("SSN",SSN);
                startActivity(intent2);
                finish();
                return true;
            case android.R.id.home:
                Intent intent = new Intent(Amin_Lajnat_Alnashat_Althaqafii_Waliielamii.this,Nayib_Amin_Lajnat_Alnashat_Alaijtimaeii_Walrihlat.class);
                intent.putExtra("رئيس اتحاد الطلبة",Rayiys_Aitihad_Altalaba);
                intent.putExtra("نائب رئيس اتحاد الطلبة",Nayib_Rayiys_Aitihad_Altalaba);
                intent.putExtra("امين لجنة الاسر",Amin_Lajnat_Alusar);
                intent.putExtra("نائب امين لجنة الاسر",Nayib_Amin_Lajnat_Alusar);
