...
public class Amin_Lajnat_Aljawalih_Walkhidmat_Al3amih extends AppCompatActivity implements RecyclerView_InterFace {
    ...
    String Rayiys_Aitihad_Altalaba, Nayib_Rayiys_Aitihad_Altalaba, Amin_Lajnat_Alusar, Nayib_Amin_Lajnat_Alusar,SSN;
    TextView tv_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_name.setText("امين لجنة الجواله والخدمة العامه");
    ...
    private void getList() {
        db.getReference("المرشحون").child("امين لجنة الجواله والخدمة العامه").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {

                list=new ArrayList <>();
                votingAdapter = new VotingAdapter(Amin_Lajnat_Aljawalih_Walkhidmat_Al3amih.this,list,Amin_Lajnat_Aljawalih_Walkhidmat_Al3amih.this);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Amin_Lajnat_Aljawalih_Walkhidmat_Al3amih.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
//    public void btnNext(View view) {
//        Intent intent = new Intent(Amin_Lajnat_Aljawalih_Walkhidmat_Al3amih.this, Nayib_Amin_Lajnat_Aljawalih_Walkhidmat_Al3amih.class);
...
//        intent.putExtra("امين لجنة الجواله والخدمة العامه",votingAdapter.getRadioButtonValue);
//        startActivity(intent);
//    }

    @Override
    public void onItemClick(final int position) {
        new AlertDialog.Builder(Amin_Lajnat_Aljawalih_Walkhidmat_Al3amih.this)
                .setTitle("تاكيد")
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.AB_home:
                Intent intent2 = new Intent(Amin_Lajnat_Aljawalih_Walkhidmat_Al3amih.this, Home_Student.class);
                intent2.putExtra("SSN",SSN);
                startActivity(intent2);
                finish();
                return true;
            case android.R.id.home:
                Intent intent = new Intent(Amin_Lajnat_Aljawalih_Walkhidmat_Al3amih.this,Nayib_Amin_Lajnat_Alusar.class);
                intent.putExtra("رئيس اتحاد الطلبة",Rayiys_Aitihad_Altalaba);
                intent.putExtra("نائب رئيس اتحاد الطلبة",Nayib_Rayiys_Aitihad_Altalaba);
                intent.putExtra("امين لجنة الاسر",Amin_Lajnat_Alusar);
                intent.putExtra("SSN",SSN);
