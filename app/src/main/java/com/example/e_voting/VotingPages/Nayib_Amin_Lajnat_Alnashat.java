...
public class Nayib_Amin_Lajnat_Alnashat extends AppCompatActivity implements RecyclerView_InterFace {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_name.setText("نائب امين لجنة النشاط العلمي والتكنولوجي");
    ...
    private void getList() {
        db.getReference("المرشحون").child("نائب امين لجنة النشاط العلمي والتكنولوجي").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {

                list=new ArrayList <>();
                votingAdapter = new VotingAdapter(Nayib_Amin_Lajnat_Alnashat.this,list, Nayib_Amin_Lajnat_Alnashat.this);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Nayib_Amin_Lajnat_Alnashat.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }

//    public void btnNext(View view) {
//        Intent intent = new Intent(Nayib_Amin_Lajnat_Alnashat.this, Amin_Lajnat_Alnashat_Alaijtimaeii_Walrihlat.class);
...
//        intent.putExtra("نائب امين لجنة النشاط",votingAdapter.getRadioButtonValue);
//        startActivity(intent);
//    }

    @Override
    public void onItemClick(final int position) {
        new AlertDialog.Builder(Nayib_Amin_Lajnat_Alnashat.this)
                .setTitle("تاكيد")
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.AB_home:
                Intent intent2 = new Intent(Nayib_Amin_Lajnat_Alnashat.this, Home_Student.class);
                intent2.putExtra("SSN",SSN);
                startActivity(intent2);
                finish();
                return true;
            case android.R.id.home:
                Intent intent = new Intent(Nayib_Amin_Lajnat_Alnashat.this,Amin_Lajnat_Alnashat.class);
                intent.putExtra("رئيس اتحاد الطلبة",SSN);
                intent.putExtra("نائب رئيس اتحاد الطلبة",SSN);
                intent.putExtra("امين لجنة الاسر",SSN);
                intent.putExtra("نائب امين لجنة الاسر",SSN);
                intent.putExtra("امين لجنة الجواله والخدمة العامه",SSN);
                intent.putExtra("نائب امين لجنة الجواله والخدمة العامه",SSN);
                intent.putExtra("SSN",SSN);
                startActivity(intent);
                finish();
                break;
