...
public class Nayib_Amin_Lajnat_Alnashat_Alaijtimaeii_Walrihlat extends AppCompatActivity implements RecyclerView_InterFace {
    ...
    String Rayiys_Aitihad_Altalaba, Nayib_Rayiys_Aitihad_Altalaba, Amin_Lajnat_Alusar, Nayib_Amin_Lajnat_Alusar,
            ...
            ,Nayib_Amin_Lajnat_Alnashat, Amin_Lajnat_Alnashat_Alaijtimaeii_Walrihlat,SSN;
    TextView tv_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_name.setText("نائب امين لجنة النشاط الاجتماعي والرحلات");
    ...
    private void getList() {
        db.getReference("المرشحون").child("نائب امين لجنة النشاط الاجتماعي والرحلات").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {

                list=new ArrayList <>();
                votingAdapter = new VotingAdapter(Nayib_Amin_Lajnat_Alnashat_Alaijtimaeii_Walrihlat.this,list, Nayib_Amin_Lajnat_Alnashat_Alaijtimaeii_Walrihlat.this);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Nayib_Amin_Lajnat_Alnashat_Alaijtimaeii_Walrihlat.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }

//    public void btnNext(View view) {
//        Intent intent = new Intent(Nayib_Amin_Lajnat_Alnashat_Alaijtimaeii_Walrihlat.this, Amin_Lajnat_Alnashat_Althaqafii_Waliielamii.class);
...
//        intent.putExtra("نائب امين لجنة النشاط الاجتماعي والرحلات",votingAdapter.getRadioButtonValue);
//        startActivity(intent);
//    }

    @Override
    public void onItemClick(final int position) {
        new AlertDialog.Builder(Nayib_Amin_Lajnat_Alnashat_Alaijtimaeii_Walrihlat.this)
                .setTitle("تاكيد")
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.AB_home:
                Intent intent2 = new Intent(Nayib_Amin_Lajnat_Alnashat_Alaijtimaeii_Walrihlat.this, Home_Student.class);
                intent2.putExtra("SSN",SSN);
                startActivity(intent2);
                finish();
                return true;
            case android.R.id.home:
                Intent intent = new Intent(Nayib_Amin_Lajnat_Alnashat_Alaijtimaeii_Walrihlat.this,Amin_Lajnat_Alnashat_Alaijtimaeii_Walrihlat.class);
                intent.putExtra("رئيس اتحاد الطلبة",Rayiys_Aitihad_Altalaba);
                intent.putExtra("نائب رئيس اتحاد الطلبة",Nayib_Rayiys_Aitihad_Altalaba);
                intent.putExtra("امين لجنة الاسر",Amin_Lajnat_Alusar);
                intent.putExtra("نائب امين لجنة الاسر",Nayib_Amin_Lajnat_Alusar);
